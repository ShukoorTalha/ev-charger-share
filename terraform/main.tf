# EV ChargerShare - AWS EKS Auto Mode Deployment
# This configuration creates an EKS Auto Mode cluster with all necessary resources
...
# IAM Role for EKS Node Group (Auto Mode)
