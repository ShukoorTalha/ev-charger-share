...
echo "   Cluster Name: evchargershare"
echo "   Nodes: $(kubectl get nodes --no-headers | wc -l)"
echo "   Context: kind-evchargershare"
echo ""
echo "🔧 Next steps:"
echo "   1. Build and deploy with Skaffold: skaffold dev"
echo "   2. Or deploy manually: kubectl apply -f k8s/"
echo "   3. Access the application at: http://localhost:8080"
echo ""
echo "🛠️  Useful commands:"
echo "   kubectl get pods -n evchargershare"
